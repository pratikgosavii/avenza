        ...
        ChartJs.prototype.init = function() {
            ...
            var radarChart = {
                ...
                datasets: [{
                        ...
                        borderColor: radarChartColors[1], //"#1c84ee",
                        pointBackgroundColor: radarChartColors[1], //"#1c84ee",
                        pointBorderColor: "#fff",
                        pointHoverBackgroundColor: "#fff",
                        pointHoverBorderColor: radarChartColors[1], //"#1c84ee",
                        data: [65, 59, 90, 81, 56, 55, 40]
                    },
                    {
                        label: "Tablets",
                        backgroundColor: radarChartColors[2], //"rgba(81, 86, 190, 0.2)",
                        borderColor: radarChartColors[3], //"#1c84ee",
                        pointBackgroundColor: radarChartColors[3], //"#1c84ee",
                        pointBorderColor: "#fff",
                        pointHoverBackgroundColor: "#fff",
                        pointHoverBorderColor: radarChartColors[3], //"#1c84ee",
